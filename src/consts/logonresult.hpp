#ifndef __TINY_STEAM_CLIENT_LOGONRESULT_HPP__
#define __TINY_STEAM_CLIENT_LOGONRESULT_HPP__

inline const char* s_LogonResult[] =
{
	"Invalid",
	"OK",
	"Fail",
...
#endif // !__TINY_STEAM_CLIENT_LOGONRESULT_HPP__
