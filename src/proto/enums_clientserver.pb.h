...
#ifndef PROTOBUF_enums_5fclientserver_2eproto__INCLUDED
#define PROTOBUF_enums_5fclientserver_2eproto__INCLUDED
...
void  protobuf_AddDesc_enums_5fclientserver_2eproto();
void protobuf_AssignDesc_enums_5fclientserver_2eproto();
void protobuf_ShutdownFile_enums_5fclientserver_2eproto();
...
const EMsg EMsg_MIN = k_EMsgInvalid;
const EMsg EMsg_MAX = k_EMsgBaseSecretServer;
...
const EClientPersonaStateFlag EClientPersonaStateFlag_MIN = k_EClientPersonaStateFlagStatus;
const EClientPersonaStateFlag EClientPersonaStateFlag_MAX = k_EClientPersonaStateFlagWatching;
const int EClientPersonaStateFlag_ARRAYSIZE = EClientPersonaStateFlag_MAX + 1;

const ::google::protobuf::EnumDescriptor* EClientPersonaStateFlag_descriptor();
inline const ::std::string& EClientPersonaStateFlag_Name(EClientPersonaStateFlag value) {
  return ::google::protobuf::internal::NameOfEnum(
    EClientPersonaStateFlag_descriptor(), value);
}
inline bool EClientPersonaStateFlag_Parse(
    const ::std::string& name, EClientPersonaStateFlag* value) {
...
const EMsgClanAccountFlags EMsgClanAccountFlags_MIN = k_EMsgClanAccountFlagPublic;
const EMsgClanAccountFlags EMsgClanAccountFlags_MAX = k_EMsgClanAccountFlagOGG;
const int EMsgClanAccountFlags_ARRAYSIZE = EMsgClanAccountFlags_MAX + 1;
...
inline const ::std::string& EMsgClanAccountFlags_Name(EMsgClanAccountFlags value) {
  return ::google::protobuf::internal::NameOfEnum(
    EMsgClanAccountFlags_descriptor(), value);
}
inline bool EMsgClanAccountFlags_Parse(
    const ::std::string& name, EMsgClanAccountFlags* value) {
...
const ESteamReviewScore ESteamReviewScore_MIN = k_ESteamReviewScore_None;
const ESteamReviewScore ESteamReviewScore_MAX = k_ESteamReviewScore_OverwhelminglyPositive;
const int ESteamReviewScore_ARRAYSIZE = ESteamReviewScore_MAX + 1;
...
inline const ::std::string& ESteamReviewScore_Name(ESteamReviewScore value) {
  return ::google::protobuf::internal::NameOfEnum(
    ESteamReviewScore_descriptor(), value);
}
inline bool ESteamReviewScore_Parse(
    const ::std::string& name, ESteamReviewScore* value) {
...
#endif  // PROTOBUF_enums_5fclientserver_2eproto__INCLUDED
